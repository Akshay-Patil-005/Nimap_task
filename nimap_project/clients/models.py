...
#     users = models.ManyToManyField(User, related_name='assigned_projects')  # Added related_name here
#     created_at = models.DateTimeField(auto_now_add=True)
#     updated_at = models.DateTimeField(auto_now=True)  # Add this line

#     created_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='created_projects')  # Added related_name here
