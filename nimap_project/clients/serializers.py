...
#         return obj.created_by.username  # You can return full_name or first_name + last_name if preferred
# class ProjectSerializer(serializers.ModelSerializer):
#     class Meta:
#         model = Project
#         fields = ['id', 'project_name', 'client', 'users', 'created_at', 'created_by']
...
#     class Meta:
#         model = Project
#         fields = ['id', 'project_name', 'client_name', 'users', 'created_at', 'created_by', 'updated_at']
